...
function createtime()
{
  ...
  o=new Date("02/18/2023 00:00:00"),
  ...
  let c=""
c=s<17&&s>=9?
`<img class='boardsign' src='https://img.shields.io/badge/河边小院-上班摸鱼中-6adea8?style=social&logo=cakephp' title='努力赚钱ing~'>
<br> <div style="font-size:13px;font-weight:bold">本站已经运行了 ${r} 天 ${s} 小时 ${l} 分 ${b} 秒 </div>`:
