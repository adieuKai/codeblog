var now=new Date;
function createtime()
{now.setTime(now.getTime()+1e3);var e=new Date("18/02/2023 00:00:00 00:00:00"),
t=Math.trunc(234e8+(now-e)/1e3*17),a=(t/1496e5).toFixed(6),
o=new Date("18/02/2023 00:00:00"),n=(now-o)/1e3/60/60/24,
...
c=s<18&&s>=9?`<img class='boardsign' src='https://img.shields.io/badge/河边小院-上班摸鱼中-6adea8?style=social&logo=cakephp' title='努力赚钱ing~'>
